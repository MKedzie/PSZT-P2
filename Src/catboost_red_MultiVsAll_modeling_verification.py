...
model_red.save_model("./catboost modele i wyniki/CPU RED MultiVsAll verification")
...
time_after = time.time()
model_red_GPU.save_model("./catboost modele i wyniki/GPU RED MultiVsAll verification")
