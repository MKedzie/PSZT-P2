...
messages_file = open("./catboost modele i wyniki/models WHITE MultiVsAll verification", mode="w+")
...
model_white.save_model("./catboost modele i wyniki/CPU WHITE MultiVsAll verification")
...
time_after = time.time()
model_white_GPU.save_model("./catboost modele i wyniki/GPU WHITE MultiVsAll verification")
