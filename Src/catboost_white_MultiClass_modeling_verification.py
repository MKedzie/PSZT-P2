...
messages_file = open("./catboost modele i wyniki/models WHITE MultiClass verification", mode="w+")
...
model_white.save_model("./catboost modele i wyniki/CPU WHITE MultiClass verification")
...
time_after = time.time()
model_white_GPU.save_model("./catboost modele i wyniki/GPU WHITE MultiClass verification")
