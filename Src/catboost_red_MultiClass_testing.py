...
red_model_CPU_basic.load_model("./catboost modele i wyniki/CPU RED MultiClass")
red_model_GPU_basic = catboost.CatBoostClassifier()
red_model_GPU_basic.load_model("./catboost modele i wyniki/GPU RED MultiClass")
messages_file = open("./catboost modele i wyniki/models RED MultiClass results", mode="w+")
