...
red_model_CPU_basic.load_model("./catboost modele i wyniki/CPU RED basic")
red_model_GPU_basic = catboost.CatBoostClassifier()
red_model_GPU_basic.load_model("./catboost modele i wyniki/GPU RED basic")
messages_file = open("./catboost modele i wyniki/models RED basic results", mode="w+")
