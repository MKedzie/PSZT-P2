...
white_model_CPU_basic.load_model("./catboost modele i wyniki/CPU WHITE basic verification")
white_model_GPU_basic = catboost.CatBoostClassifier()
white_model_GPU_basic.load_model("./catboost modele i wyniki/GPU WHITE basic verification")
messages_file = open("./catboost modele i wyniki/models WHITE basic results verification", mode="w+")
