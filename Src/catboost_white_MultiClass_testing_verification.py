...
white_model_CPU_basic.load_model("./catboost modele i wyniki/CPU WHITE MultiClass verification")
white_model_GPU_basic = catboost.CatBoostClassifier()
white_model_GPU_basic.load_model("./catboost modele i wyniki/GPU WHITE MultiClass verification")
messages_file = open("./catboost modele i wyniki/models WHITE MultiClass results verification", mode="w+")
