...
white_model_CPU_basic.load_model("./catboost modele i wyniki/CPU WHITE MultiVsAll")
white_model_GPU_basic = catboost.CatBoostClassifier()
white_model_GPU_basic.load_model("./catboost modele i wyniki/GPU WHITE MultiVsAll")
messages_file = open("./catboost modele i wyniki/models WHITE MultiVsAll results", mode="w+")
